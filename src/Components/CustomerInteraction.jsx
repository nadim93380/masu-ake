...
const CustomerInteraction = () => {
    return (
        <div>
            <div className="flex w-11/12 md:w-10/12 mx-auto justify-around items-center my-8 flex-col md:flex-row ">
                <div className="flex flex-col max-w-xl p-8 shadow-sm rounded-xl lg:p-12 bg-gray-700 text-gray-100">
                ...
                <div className="flex flex-col max-w-xl p-8 shadow-sm rounded-xl lg:p-12 bg-gray-700 text-gray-100">
                    ...
                    <div className="flex items-center justify-center">
                        <a rel="noopener noreferrer" className="text-sm text-gray-400">Maybe later</a>
                    </div>
                </div>
            </div>
        </div>
